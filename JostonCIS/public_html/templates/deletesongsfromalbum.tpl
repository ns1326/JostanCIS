    ...
    <div class="col">
        ...
        <div class="row">
            ...
            <div class="col-8 bg-light  nospacing">
                ...
                <!--Table-->        
                <form action="viewalbum.html" method="POST" id="viewalbum">     
                <!-- <form action="addsongsforalbum.html" method="POST" id="viewalbum"> -->
                ...
                <div class="row ml-3 mb-3">
                    <button type="delete" form="viewalbum" name="delete" >Delete</button>                    
                </div>                            
            </div>
        </div>
    </div>
